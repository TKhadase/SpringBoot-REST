...
<h3 style="color:black;text-align:center;">Account Details</h3>
</b>
<table  id="accounts" align="center">
<tr><th>Acc.No</th><th>Owner Name</th><th>Balance</th><th></th></tr>
<sform:form  modelAttribute="account">
<tr>
<td><sform:input path="accno" readonly="true"/></td><td><sform:input path="name"/></td><td><sform:input path="balance"/></td><td><input type="submit"  value="SUBMIT"/>  </td>
</tr>
<sform:input path="isActive" hidden="true"/>
</sform:form>
</table>
